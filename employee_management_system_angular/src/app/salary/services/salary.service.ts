...
export class SalaryService {
  ...
  createSalary(salary: FormData): Observable<Object> {
  ...
  updateUploadSalary(id: number, salary: FormData): Observable<Object> {
    return this.http.post(`${this.baseUrl}/${id}`, salary);
  }
  ...
  getSalariesList(id: number): Observable<any> {
    return this.http.get(`${this.baseUrl}/all-salaries/${id}`);
  }
}
